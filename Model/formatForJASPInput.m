function forJASP = formatForJASPInput(forGramm)
    findRows.transMonoc = strcmp(forGramm.trlLabel,'A. Prefered eye monocular') ...
        & strcmp(forGramm.RESPbinLabel, 'Transient');
    findRows.transIOT = strcmp(forGramm.trlLabel,'D. Prefered eye adapted') ...
        & strcmp(forGramm.RESPbinLabel, 'Transient');
    findRows.sustMonoc = strcmp(forGramm.trlLabel,'monocular_PO_DE') ...
        & strcmp(forGramm.RESPbinLabel, 'Long Sustained');
